...
And this is all thanks to [LineageOS](http://lineageos.org/). LineageOS is a fork of [AOSP (Android Open Source Project)](https://source.android.com/) with extra features and a wide array of compatible devices. Build exist for devices like the Samsung Galaxy S3, all the way to some of the newest phones on the market.
